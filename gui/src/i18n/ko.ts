...
export const ko: Record<TKey, string> = {
  ...
  "modal.forwardUserAgentHint": "호출자의 User-Agent를 이 커스텀 업스트림으로 보냅니다. 기본은 끔(런타임/프로토콜 UA).",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.forwardUserAgentHint": "호출자의 User-Agent를 이 커스텀 업스트림으로 보냅니다. 기본은 끔(런타임/프로토콜 UA).",
