...
export const ko: Record<TKey, string> = {
  ...
  "modal.forwardUserAgent": "클라이언트 User-Agent 전달",
  "modal.forwardUserAgentHint": "호출자의 User-Agent를 이 OpenAI 호환 업스트림으로 보냅니다. 기본은 끔(Bun 런타임 UA).",
 ...
 "pws.noModelMatch": "필터와 일치하는 모델이 없습니다.",
  ...
  "pws.forwardUserAgent": "클라이언트 User-Agent 전달",
  "pws.forwardUserAgentHint": "호출자의 User-Agent를 이 OpenAI 호환 업스트림으로 보냅니다. 기본은 끔(Bun 런타임 UA).",
