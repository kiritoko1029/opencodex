...
export const de = {
  ...
  "modal.forwardUserAgentHint": "Sendet den User-Agent des Aufrufers an diesen OpenAI-kompatiblen Upstream. Standardmäßig aus (Bun-Runtime-UA).",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.forwardUserAgentHint": "Sendet den User-Agent des Aufrufers an diesen OpenAI-kompatiblen Upstream. Standardmäßig aus (Bun-Runtime-UA).",
