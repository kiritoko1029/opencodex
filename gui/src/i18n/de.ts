...
export const de = {
  ...
  "modal.forwardUserAgent": "Client-User-Agent weiterleiten",
  "modal.forwardUserAgentHint": "Sendet den User-Agent des Aufrufers an diesen benutzerdefinierten Upstream. Standardmäßig aus (Runtime-/Protokoll-UA).",
 ...
 "pws.noModelMatch": "Keine Modelle entsprechen dem Filter.",
  ...
  "pws.forwardUserAgent": "Client-User-Agent weiterleiten",
  "pws.forwardUserAgentHint": "Sendet den User-Agent des Aufrufers an diesen benutzerdefinierten Upstream. Standardmäßig aus (Runtime-/Protokoll-UA).",
