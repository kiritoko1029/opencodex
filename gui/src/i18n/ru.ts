...
// Strings with {cmd} render a <code> chip via <Trans>; {var} are plain interpolations.
  ...
  "modal.forwardUserAgentHint": "Отправлять User-Agent вызывающей стороны на этот OpenAI-совместимый upstream. По умолчанию выкл. (UA среды Bun).",
  ...
  "pws.forwardUserAgentHint": "Отправлять User-Agent вызывающей стороны на этот OpenAI-совместимый upstream. По умолчанию выкл. (UA среды Bun).",
