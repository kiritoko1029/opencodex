...
export const ru: Record<TKey, string> = {
  ...
  "modal.forwardUserAgent": "Передавать User-Agent клиента",
  "modal.forwardUserAgentHint": "Отправлять User-Agent вызывающей стороны на этот пользовательский upstream. По умолчанию выкл. (runtime/protocol UA).",
  ...
  "pws.forwardUserAgent": "Передавать User-Agent клиента",
  "pws.forwardUserAgentHint": "Отправлять User-Agent вызывающей стороны на этот пользовательский upstream. По умолчанию выкл. (runtime/protocol UA).",
