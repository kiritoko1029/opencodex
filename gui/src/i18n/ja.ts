...
export const ja: Record<TKey, string> = {
  ...
  "modal.forwardUserAgent": "クライアント User-Agent を転送",
  "modal.forwardUserAgentHint": "呼び出し元の User-Agent をこのカスタム upstream に送ります。デフォルトはオフ（ランタイム/プロトコル UA）。",
  ...
  "pws.forwardUserAgent": "クライアント User-Agent を転送",
  "pws.forwardUserAgentHint": "呼び出し元の User-Agent をこのカスタム upstream に送ります。デフォルトはオフ（ランタイム/プロトコル UA）。",
