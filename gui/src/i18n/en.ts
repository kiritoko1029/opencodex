...
export const en = {
  ...
  "modal.forwardUserAgentHint": "Send the caller's User-Agent to this custom upstream. Off by default (runtime/protocol UA).",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.forwardUserAgentHint": "Send the caller's User-Agent to this custom upstream. Off by default (runtime/protocol UA).",
