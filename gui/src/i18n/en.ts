...
export const en = {
  ...
  "modal.forwardUserAgent": "Forward client User-Agent",
  "modal.forwardUserAgentHint": "Send the caller's User-Agent to this OpenAI-compatible upstream. Off by default (Bun runtime UA).",
 ...
 "pws.noModelMatch": "No models match the filter.",
  ...
  "pws.forwardUserAgent": "Forward client User-Agent",
  "pws.forwardUserAgentHint": "Send the caller's User-Agent to this OpenAI-compatible upstream. Off by default (Bun runtime UA).",
