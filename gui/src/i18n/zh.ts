...
export const zh: Record<TKey, string> = {
  ...
  "modal.forwardUserAgent": "透传客户端 User-Agent",
  "modal.forwardUserAgentHint": "将调用方的 User-Agent 发往该 OpenAI 兼容上游。默认关闭（使用 Bun 运行时 UA）。",
 ...
 "pws.noModelMatch": "没有匹配筛选的模型。",
  ...
  "pws.forwardUserAgent": "透传客户端 User-Agent",
  "pws.forwardUserAgentHint": "将调用方的 User-Agent 发往该 OpenAI 兼容上游。默认关闭（使用 Bun 运行时 UA）。",
