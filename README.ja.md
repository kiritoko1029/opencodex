...
<p align="center">
  <a href="README.md">English</a> · <a href="README.ko.md">한국어</a> · <a href="README.zh-CN.md">简体中文</a> · <a href="README.ru.md">Русский</a> · <b>日本語</b> · 📖 <a href="https://kiritoko1029.github.io/opencodex/ja/"><b>完全なドキュメント →</b></a>
</p>
...
```bash
npm install -g --allow-scripts=bun @kiritoko1029/opencodex   # --ignore-scripts, --omit=optional なしで
...
現在のディレクトリを再インストールしてしまいます。常に `@kiritoko1029/opencodex` を明示してください。
...
全フィールドの詳細は **[設定リファレンス](https://kiritoko1029.github.io/opencodex/ja/reference/configuration/)** を参照してください。

## ドキュメント

公開ドキュメント(インストール、プロバイダー、ルーティング、サイドカー、Codex 統合、Codex App モデルピッカー、CLI/設定リファレンス)は [`docs-site/`](./docs-site) の Astro サイトとしてビルドされ
**[kiritoko1029.github.io/opencodex](https://kiritoko1029.github.io/opencodex/ja/)** に公開されます。
...
**[コントリビュート](https://kiritoko1029.github.io/opencodex/ja/contributing/)** を参照してください。
